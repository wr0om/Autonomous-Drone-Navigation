"""
This code is adapted from the controllers in the repository:
https://github.com/bitcraze/crazyflie-simulation/blob/main/simulator_files/webots/controllers/crazyflie_controller_py_wallfollowing/crazyflie_controller_py_wallfollowing.py

Original author: Bitcraze
"""
import math
